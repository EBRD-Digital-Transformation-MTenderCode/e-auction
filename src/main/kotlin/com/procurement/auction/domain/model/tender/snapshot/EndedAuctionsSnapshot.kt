...
class EndedAuctionsSnapshot(
    ...
    class Data(
        ...
        @JsonPropertyOrder("id", "lotId", "title", "description", "auctionPeriod", "value", "modalities", "bids", "progress", "results")
        class Auction(
            ...
            @field:JsonProperty("results") @param:JsonProperty("results") val results: List<Result>
        ) {
